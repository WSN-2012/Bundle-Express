...
public class SensorList extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!cd.isConnectingToInternet()) {
            ...
            alert.showAlertDialog(SensorList.this, "Internet Connection Error",
     ...
     // Loading Albums JSON in Background Thread
    		...
    		lv.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {
    			...
    			public void onItemClick(AdapterView<?> arg0, View view, int arg2,
    				...
    				Intent i = new Intent(getApplicationContext(), WebDataContent.class);
    				...
    				Toast.makeText(getApplicationContext(), "gateway Id: " + gateway_id  + ", Sensor Id: " +sensor_id, Toast.LENGTH_SHORT).show();
   ...
   /* @Override
	...
	class LoadSensors extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(SensorList.this);
		...
		protected String doInBackground(String... args) {
			...
			String json = jsonParser.makeHttpRequest(URL_SENSOR, "GET",
					params);
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					ListAdapter adapter = new SimpleAdapter(
							SensorList.this, sensorslist, R.layout.list_item_sensors, new String[] { TAG_ID,
									TAG_NAME}, new int[] {R.id.sensor_id, R.id.sensor_name});
